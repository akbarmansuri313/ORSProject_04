...
public class SubjectModel {
	...
	public long add(SubjectBean bean) throws ApplicationException, DuplicateRecordException, RecordNotFoundException {
		...
		try {
			...
			throw new ApplicationException("Excetion : add rollback Exception" + e.getMessage());
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
		return pk;
	...
	public void update(SubjectBean bean)
		...
		try {
			...
			PreparedStatement pstmt = conn
					.prepareStatement("update st_subject set name = ?, course_id = ?, course_name = ?, "
			...
			System.out.println("DAta Update suceess " + i);
