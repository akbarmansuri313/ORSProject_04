...
/**
 * UserRegistrationCtl Servlet handles user registration process. Validates
 * input, populates UserBean, and registers new user in the system.
 * 
...
public class UserRegistrationCtl extends BaseClt {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		log.debug("UserRegistrationCtl validate ended");
		return pass;
	}
