...
public class UserCtl extends BaseClt {
	...
	protected void preload(HttpServletRequest request) {
		...
		System.out.println("User preload Work");
	...
	public boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("firstName"))) {
			...
			request.setAttribute("firstName", "in Valid firstName");
			pass = false;
		}
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			request.setAttribute("lastName", PropertyReader.getValue("lastName", "inValid lastName"));
